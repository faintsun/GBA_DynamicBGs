...
# 1 "Maps/../Library/mapHandler.h" 1





# 5 "Maps/../Library/mapHandler.h"
typedef struct {
...
void moveMapDown();
# 4 "Maps/mapList.c" 2
# 1 "Maps/../Library/myLib.h" 1



typedef unsigned short u16;
typedef unsigned char u8;
# 47 "Maps/../Library/myLib.h"
...
# 85 "Maps/../Library/myLib.h"
extern unsigned int oldButtons;
extern unsigned int buttons;
# 95 "Maps/../Library/myLib.h"
...
extern DMA *dma;
# 224 "Maps/../Library/myLib.h"
typedef struct { u16 tileimg[8192]; } charblock;
typedef struct { u16 tilemap[1024]; } screenblock;
# 282 "Maps/../Library/myLib.h"
typedef struct{
...
# 1 "Maps/LittlerootTown/littleroot.h" 1
# 23 "Maps/LittlerootTown/littleroot.h"
...
# 1 "Maps/DewfordTown/dewford.h" 1
# 22 "Maps/DewfordTown/dewford.h"
...
void initialize_mapList() {
 ...
 LittlerootTown.tlen = 15488;
 LittlerootTown.map_BG2 = littlerootMap;
 LittlerootTown.mlen = 6800;
 ...
 DewfordTown.tlen = 9280;
 DewfordTown.map_BG2 = dewfordMap;
 DewfordTown.mlen = 4800;
