...
# 14 "main.c" 2
# 1 "Sprites/testSprite.h" 1
# 21 "Sprites/testSprite.h"
extern const unsigned short testSpriteTiles[16384];


extern const unsigned short testSpritePal[256];
# 15 "main.c" 2
# 1 "Sprites/s_May.h" 1
# 21 "Sprites/s_May.h"
extern const unsigned short s_MayTiles[16384];


extern const unsigned short s_MayPal[256];
# 16 "main.c" 2
 ...
 *(unsigned short *)0x4000000 = 0 | (1<<10) | (1 << 12) | (1 << 6);
 *(volatile unsigned short*)0x400000C = 0 << 2 | 28 << 8 | 0<<14 | 1 << 7;
...
void buttonHandler(CURRENTMAP* a) {
 ...
 if (!moving) {
  ...
  if((~(*(volatile unsigned int *)0x04000130) & ((1<<4)))) {
   ...
   if (a->tileR < a->worldTileH - (160 / 8) - 2) {
...
void drawPlayer() {
 ...
 if (player.aniDir != IDLE && player.aniFrame == 0 || player.aniFrame == 2) {
  shadowOAM[OAM_PLAYER].attr0 = (player.screenRow-1) | (2 << 14);
 } else {
  shadowOAM[OAM_PLAYER].attr0 = player.screenRow | (2 << 14);
 }
 if (player.aniDir == RIGHT) {
  shadowOAM[OAM_PLAYER].attr1 = (2 << 14) | player.screenCol | (1 << 12);
 } else {
  shadowOAM[OAM_PLAYER].attr1 = (2 << 14) | player.screenCol;
 }
 shadowOAM[OAM_PLAYER].attr2 = (0)*32+(0);
